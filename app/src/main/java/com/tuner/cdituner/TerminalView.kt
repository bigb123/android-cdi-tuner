...
data class CdiLogEntry(
  ...
  val data: CdiDataDisplay?
)

@Composable
fun TerminalView(cdiDataDisplay: CdiDataDisplay?, modifier: Modifier = Modifier) {
  ...
  LaunchedEffect(cdiDataDisplay) {
    cdiDataDisplay?.let {
      val timestamp = LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss"))
      val newEntry = CdiLogEntry(timestamp, cdiDataDisplay)
